...
const i18n = {
  en: {
    subject: "Your password reset code is",
    preview: "Reset your password on Omero",
    greetings: "Hi",
  ...
  "pt-br": {
    subject: "Seu código de recuperação de senha é",
    preview: "Redefina sua senha no Omero",
    greetings: "Olá",
...
export const ForgotPasswordEmail: React.FC<Readonly<TemplateProperties>> = ({
  name,
  email,
  code,
  resetButtonLink,
...
(ForgotPasswordEmail as any).PreviewProps = {
  code: "123456",
  name: "John Doe",
  email: "user@example.com",
  resetButtonLink: "http://localhost:8787/forget-password",
  language: "en",
